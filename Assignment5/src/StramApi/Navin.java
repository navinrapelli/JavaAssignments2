 ...
 class Navin {
	...
	public static void main(String[] args) {
		List<Fruit> fru=Arrays.asList(
  		      ...
  		      new Fruit("Strwabeery", 120, 55, "Red"),
		...
		List<News> news1=Arrays.asList(
	  		      ...
	  		      new News(23, "Venky", "Naga","I supported to MI "),
		...
		List<Trader> Trade=Arrays.asList(
	  		      ...
	  		      new Trader("Chichya","Pune"),
	  		      new Trader("Chintu", "Mumbai"),
	  		      new Trader("Amol","Pune"),
	  		      new Trader("Akash","Delhi"),
	  		      new Trader("Rohan","Delhi"),
	  		      new Trader("Sagar","Pune")
	  			);
		...
		.forEach(t->System.out.println("year="+t.year+" value="+t.value));
				...
				//What are all the unique cities where the traders work?
				 ...
				 //Find all traders from Pune and sort them by name.
		           ...
		           Trade.stream()
		   		.filter(t->t.TradeCity.equals("Pune"))
				...
				//Return a string of all traders’ names sorted alphabetically.
				 ...
				 //Are any traders based in Indore?
		           ...
		           boolean a=Trade.stream()
		            .anyMatch(t->t.TraderName.equals("indore"));  
		...
		//Print all transactions’ values from the traders living in Delhi.
		           System.out.println("\nall transactions’ values from the traders living in Delhi") ; 
		            ...
		            Tran.stream()
		            .filter(t->t.trader.TradeCity.equals("Delhi"))
